...
PAGES = {
    "ImageClassification": use_cnn,
    }
#st.sidebar.subheader("Navigation")
main_navigation = st.sidebar.radio("Navigation", ["ImageClassification"])
st.sidebar.markdown("")

if main_navigation=="ImageClassification":
    use_case="ImageClassification"
